...
const BentoCard = ({
  ...
  <div
    ...
    <div
      ...
      <h3 className="text-3xl sm:text-4xl font-serif font-bold text-center mb-4 text-white">
        {name}
      </h3>
      <p className="text-base sm:text-lg text-center mb-8 max-w-2xl mx-auto text-white font-sans leading-relaxed">{description}</p>
    </div>
